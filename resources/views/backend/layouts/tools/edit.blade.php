            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            <form class="forms-sample" action="{{ route('tools.update',['id' => $data->id]) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group row mb-3">
                                        <div class="col">
                                            <label class="form-lable required">Excel File:</label>
                                            <input class="form-control dropify @error('excel_file') is-invalid @enderror"
                                                   type="file"
                                                   data-default-file="{{ asset('/' . $data->excel_file) }}"
                                                   name="excel_file">
                              ...
                              <a href="{{ route('tools.index') }}" class="btn btn-danger ">Cancel</a>
                          </form>
                        </div>
                    </div>
                </div>
